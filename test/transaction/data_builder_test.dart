...
void main() {
  group('building data output scripts', () {
    ...
    test('can handle larger data pushes', (){
      ...
      var lockBuilder = UnspendableDataLockBuilder(utf8.encode(data));
    ...
    test('fails if old-style OP_RETURN', () {
      ...
      expect(() => UnspendableDataLockBuilder.fromScript(script), throwsException);
    });

    test('should create script from some data', () {
      var data = HEX.decode('bacacafe0102030405');

      var lockBuilder = UnspendableDataLockBuilder(data);
