...
//        });
  ...
  Transaction buildCreditingTransaction(SVScript scriptPubKey, BigInt amount) {
        ...
        coinbaseUnlockBuilder.fromScript(unlockingScript);
        ...
        var lockingScriptBuilder = DefaultLockBuilder();
        lockingScriptBuilder.fromScript(scriptPubKey);
        var output = TransactionOutput(amount, lockingScriptBuilder);
