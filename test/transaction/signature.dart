...
main(){
    ...
    /* FIXME : I don't see value here. Leaving it for now
    var fromAddress = Address('mszYqVnqKoQx4jcTdJXxwKAissE3Jbrrc1');
    var privateKey = SVPrivateKey.fromWIF('cSBnVM4xvxarwGQuAfQFwqDg9k5tErHUHzgWsEfD4zdwUasvqRVY');
    var simpleUtxoWith100000Satoshis = {
        "address": fromAddress,
        "txId": 'a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458',
        "outputIndex": 0,
        "script": SVScript.buildPublicKeyHashOut(fromAddress).toString(),
        "satoshis": 100000
    };

    var getSignatureFromTransaction = () {
        var transaction = new Transaction();
        transaction.spendFromMap(simpleUtxoWith100000Satoshis);
