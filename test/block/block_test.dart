...
void main() {
    ...
    var blockhex = block86756["blockhex"] as String;
    List<int> blockbuf = HEX.decode(blockhex);
    var blockHeader = BlockHeader.fromBuffer(HEX.decode(block86756["blockheaderhex"] as String));
    ...
    late List<int> dataRawBlockBuffer, dataRawBlockBinary;
    ...
    group('Block', () {
        ...
        group('#toObject', () {
            ...
            test('roundtrips correctly', () {
                var block = Block.fromBuffer(blockOneBuf);
                var obj = block.toObject() as Map<String, dynamic>;
        ...
        group('#fromRawBlock', () {
            test('should instantiate from a raw block binary', () {
                ...
                expect(BigInt.from(x.header!.bits as int).toRadixString(16), equals('1c3fffc0'));
            });
